...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import FastTransforms_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("34b6f7d7-08f9-5794-9e10-3819e4c7e49a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "FastTransforms", artifacts_toml) for e in artifacts["FastTransforms"]]
...
if best_platform === nothing
    @debug("Unable to load FastTransforms; unsupported platform $(triplet(platform_key_abi()))")
else
